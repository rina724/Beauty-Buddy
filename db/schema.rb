...
ActiveRecord::Schema[7.2].define(version: 2024_10_31_074819) do
  ...
  create_table "profiles_ingredients", force: :cascade do |t|
    t.bigint "profile_id"
    t.bigint "ingredient_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ingredient_id"], name: "index_profiles_ingredients_on_ingredient_id"
    t.index ["profile_id"], name: "index_profiles_ingredients_on_profile_id"
  end
  ...
  add_foreign_key "profiles_ingredients", "ingredients"
  add_foreign_key "profiles_ingredients", "profiles"
end
